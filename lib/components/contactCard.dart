...
class _ContactCardState extends State<ContactCard>
  ...
  Widget frontSide = LayoutBuilder(builder: (p0, constraints) {
    return Column(
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              ...
              Variables.scrollController.position.ensureVisible(
  ...
  getWidth() {
    return dragPosition > 180
        ? (130 + (180 - dragPosition) * 1.44)
        : 130 - (dragPosition * 1.44);
  }
}
