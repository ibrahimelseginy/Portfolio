...
class AppBarCustom extends StatefulWidget {
  const AppBarCustom(
      {super.key, required this.keys, required this.scrollController});
                          ...
                          return Expanded(
                            child: Row(
                              ...
                              children: [
                                ...
                                AppBarButton(
                                    onTap: () {
                                      AnalyticsService.logAppBarButton("Home",
                                          type: "AppBar");
                                ...
                                AppBarButton(
                                    onTap: () {
                                      AnalyticsService.logAppBarButton("About",
                                          type: "AppBar");
                                      widget.scrollController.position
                                          .ensureVisible(
                                ...
                                AppBarButton(
                                    onTap: () {
                                      AnalyticsService.logAppBarButton("Social",
                                          type: "AppBar");
                                      widget.scrollController.position
                                          .ensureVisible(
          ...
          children: [
            ValueListenableBuilder<int>(
              ...
              builder: (context, view, child) {
                return AnimatedContainer(
                  ...
                  height:
                      ((hovered.value == count) || (view == count)) ? 30 : 0,
                  curve: Curves.easeIn,
                  width:
                      ((hovered.value == count) || (view == count)) ? 100 : 0,
                  decoration: BoxDecoration(
                      gradient: hovered.value == count
                          ? LinearGradient(
                              colors: [
                      ...
                      border: ((view == count) && (hovered.value != count))
            ...
            SizedBox(
              ...
              child: Texter(
                ...
                style: TextStyle(
                    color:
                        (hovered.value == count) ? Colors.white : Colors.white,
                    fontSize: 20,
                    fontWeight: FontWeight.w500,
                    shadows: const [
                      BoxShadow(
                          color: Colors.black, spreadRadius: 8, blurRadius: 7)
                    ]),
              ),
            ),
          ],
